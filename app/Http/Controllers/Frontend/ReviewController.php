...
class ReviewController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        // ('product_id') = dari name di form index.blade.php
        ...
        if ($product) {
            ...
            if ($new_review) {
                ...
                //                 return redirect('view-category/' . $category_slug . '/' . $prod_slug)->with('status', "Thank you for writing a review");
                // view-category = punyaku sendiri,
                // sedangkan di youtube, pakai category.
            }
        } else {
            return redirect()->back()->with('status', "The link you followed was broken");
        }
    ...
    public function update(Request $request)
    {
        //user_review
        //review_id
        // keduanya dari name="" page edit.blade.php
        $user_review = $request->input('user_review');
        ...
        if ($user_review != '') {
            ...
            if ($review) {
                ...
                // di youtube pakai "category", di pny saya pakai "view-category"
