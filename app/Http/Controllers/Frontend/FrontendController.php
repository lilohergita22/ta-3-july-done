...
class FrontendController extends Controller
{
    public function index()
    {
        ...
        // return view('frontend.landingpage', compact('featured_products', 'trending_category'));
    ...
    public function searchProduct(Request $request)
    {
        ...
        // $request from paramete, 
        // product_name = dari name="product_name" pada frontnavbar.blade tag form

        if ($searched_product != "") {
            $product = Product::where("name", "LIKE", "%$searched_product%")->first();
            // $product = adalah table product pada database
